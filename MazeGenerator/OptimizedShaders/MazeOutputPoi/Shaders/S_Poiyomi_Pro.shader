Shader "Hidden/Locked/.poiyomi/★ Poiyomi Pro ★/MazeOutputPoi-MazeOutputPoi"
{
    Properties
    {
...
#define PROP_GITDEMAXEMISSIONMULTIPLIER 0.1
#define PROP_GITDEMINLIGHT 1
#define PROP_GITDEMAXLIGHT 0
